  ...
  Future<void> _downloadCard(BuildContext context, GlobalKey cardKey) async {
    try {
      ...
      if (!kIsWeb) {
        ...
        if (!status.isGranted) {
          throw 'Permission de stockage refusée';
        }
      }
      ...
      if (kIsWeb) {
        ...
        final path =
            '$downloadsPath/carte_promettant_${DateTime.now().millisecondsSinceEpoch}.png';
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('✅ Carte enregistrée dans Téléchargements'),
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // SizedBox(height: screenHeight * 0.02),
            // _buildTextField('Groupe Sanguin', Icons.bloodtype, _groupeSanguinController, 'Ex: O+, A-, B+...', isRequired: false),
            // _buildTextField('Allergies', Icons.health_and_safety, _allergiesController, 'Mentionner les allergies (optionnel)', maxLines: 2, isRequired: false),
            SizedBox(height: screenHeight * 0.03),
