...
//       try {
//         // Appel à AuthService pour enregistrer dans Isar
//         final success = await AuthService.register(
//           nom: _nomController.text.trim(),
//           prenom: _prenomController.text.trim(),
//           email: _emailController.text.trim().isEmpty
//               ? null
//               : _emailController.text.trim(), // Optionnel
...
//             const SnackBar(
//               content: Text(
//                 'Inscription réussie ! Vos données sont enregistrées.',
//               ),
...
//             const SnackBar(
//               content: Text(
//                 'Erreur : Téléphone déjà utilisé ou mots de passe non identiques.',
//               ),
//               backgroundColor: Color(0xFFD32F2F),
//             ),
//           );
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // ✅ Container noir arrondi (sans Expanded)
                  SlideTransition(
                    position: _slideAnimation,
                    child: FadeTransition(
                      opacity: _fadeAnimation,
                      child: Container(
                        width: double.infinity,
                        // ✅ RETIRÉ: height minimum pour permettre le scroll
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // ✅ Déjà un compte (bien visible maintenant)
                                Center(
                                  child: TextButton(
                                    onPressed: () {
                                      Navigator.push(
                                ...
                                // ✅ AJOUT: Espacement en bas pour éviter le chevauchement
                                SizedBox(height: screenHeight * 0.03),
                              ],
                            ),
                          ),
