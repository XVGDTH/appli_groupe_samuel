...
class _HistoriquePageState extends State<HistoriquePage>
  ...
  Widget _buildCategoryFilter(double screenWidth, double screenHeight) {
    return Container(
      height: screenHeight * 0.13, // Hauteur ajustée pour éviter l'overflow
      ...
      child: Column(
        children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: isSelected
                                ...
                                : category['color'] as Color,
                            fontWeight: FontWeight.bold,
                            fontSize: screenWidth * 0.03, // Légèrement réduit
                          ),
                        ),
                      ],
                    ),
          ...
          // Barre de défilement personnalisée colorée (bleue)
          SizedBox(height: screenHeight * 0.008), // Réduit
          Container(
          ...
          SizedBox(height: screenHeight * 0.005), // Petit espacement final
        ],
      ),
    );
  }
